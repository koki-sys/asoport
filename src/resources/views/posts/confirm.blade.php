    ...
    <div class="row">
        ...
        <div class="col-md-8 mt-5">
            <div class="mb-5 text-center">
                ...
                <span style="font-size: 1.5rem; font-weight: bold;">内容を確認してください</span>
            </div>
                ...
                <div class="text-center box-center">
                    ...
                    <div class="m-3 pt-3">
                        <div class="text-left"><span
                                style="font-size: 1.1rem; font-weight: bold;">ポートフォリオサイトURL</span><span
                                class="pl-4">{{$input_data['port']}}</span></div>
                        <input name="port" value="{{$input_data['port']}}" type="hidden">
                    </div>
                    <div class="m-3 pt-2">
                        <div class="text-left"><span style="font-size: 1.1rem; font-weight: bold;">GitHub
                                URL</span><span class="pl-4">{{$input_data['git']}}</span></div>
                        <input name="git" value="{{$input_data['git']}}" type="hidden">
                    </div>
                    <div class="m-3 pt-2">
                        <div class="text-left"><span style="font-size: 1.1rem; font-weight: bold;">使用技術</span><span
                                class="pl-4">{{$language}}</span></div>
                        <input name="lang" value="{{ $language }}" type="hidden">
                    </div>
                    <div class="m-3 pt-2">
                        <div class="text-left"><span style="font-size: 1.1rem; font-weight: bold;">ひとこと</span><span
                                class="pl-4">{{ $input_data['comment']}}</span></div>

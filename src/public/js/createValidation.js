...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (validationForm) {
    ...
    var langExists = function langExists() {
      // required-langクラスを指定された要素の集まり
      var langElems = Array.from(document.querySelectorAll('.required-lang'));
      return langElems.find(function (elem) {
        var checked = elem.parentElement.querySelector('input[type="checkbox"]:checked');
        return checked != null;
      });
